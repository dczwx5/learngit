...
package QFLib.QEngine.Renderer.Material.Shaders
{
    ...
    public final class FFilterBlurTint extends FBase implements IFragmentShader
    {
        public static const Name : String = "filter.blur.tint";

        static private const cWeight : String = "fc0";
        static private const cColor : String = "fc1";

        public function FFilterBlurTint()
        {
            registerTex( 0, mainTexture );
            registerParam( 0, "weights" );
            registerParam( 1, "color" );
        }
        ...
        public function get code() : String
        {
            var fs : String =
                    ...
                    GA.adds( "ft5", "ft3" ) +
                    GA.adds( "ft5", "ft4" ) +
                    GA.mul( "ft5.xyz", cColor + ".xyz", "ft5.www" ) +
                    GA.mul( outColor, "ft5", cColor + ".wwww" );
            return fs;
        }
    }
}