...
package QFLib.QEngine.Renderer.Utils
{
    ...
    public class RectangleUtil
    {
         ...
         *
         *  @see QFLib.Graphics.RenderCore.starling.utils.ScaleMode
         */
        ...
        public static function unionPoint( x : Number, y : Number, resultRect : Rectangle = null ) : Rectangle
        {
            if( resultRect == null )
            {
            ...
            if( resultRect.left > x )
            {
                resultRect.left = x;
            }
            else if( resultRect.right < x )
            {
                resultRect.right = x;
            }
        ...
        public static function unionRect( rect1 : Rectangle, rect2 : Rectangle, resultRect : Rectangle = null ) : Rectangle
        {
            if( resultRect == null )resultRect = new Rectangle();
