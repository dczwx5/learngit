...
package QFLib.QEngine.Animation.SpineExt
{
    import QFLib.Foundation;
    import QFLib.Foundation.CPath;
    import QFLib.Math.CAABBox2;
    import QFLib.Math.CVector2;
    import QFLib.QEngine.Loader.SpineLoader;
    ...
    {
        public function AnimationBounds()
        {
        }
        ...
        private var m_theSpineLoaderRef : SpineLoader = null;
        ...
        public function loadFile( sFilename : String, theSpineLoader : SpineLoader,
        ...
        public function createEmptyAnimationBounds( theSpineLoader : SpineLoader ) : void
        {
        ...
        private function _calculateAnimationBound( iAnimationIndex : int, bExtractAnimationOffset : Boolean = false, vExtractAnimationOffsetBoneIndices : Vector.<int> = null ) : CAABBox2
        {
            ...
            for( var j : int = 0; j < iNumAdvanceTimes; j++ )
            {
                ...
                {
                    m_theSpineLoaderRef.skeletonAnimation.advanceTime( fTimeSlice, true );
