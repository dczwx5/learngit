...
package QFLib.QEngine.Renderer.Events
{
    ...
    import QFLib.QEngine.Renderer.Utils.FormatString;
    ...
    public class Event
    {
        ...
        /** Event type that is dispatched by the AssetManager before a render. */
        ...
        public static const SLOTCHANGE : String = "slotChange";
        ...
        /** @private */
        Engine_Internal static function fromPool( type : String, bubbles : Boolean = false, data : Object = null ) : Event
        {
        ...
        /** @private */
        Engine_Internal static function toPool( event : Event ) : void
        {
        ...
        /** @private */
        Engine_Internal function reset( type : String, bubbles : Boolean = false, data : Object = null ) : Event
        {
            mType = type;
            mBubbles = bubbles;
            mData = data;
