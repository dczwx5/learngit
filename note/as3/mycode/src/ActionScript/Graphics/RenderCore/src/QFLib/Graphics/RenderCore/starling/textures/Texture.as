...
package QFLib.Graphics.RenderCore.starling.textures
{
    ...
    public class Texture
    {
        ...
        public var isTobeRecycled : Boolean = false;
                                           ...
                                           async:Function=null, repeat:Boolean=false):Texture
        {
			...
			if (atfData.width < 4 || atfData.height < 4)
			{
				...
				texture.onRestore = function():void { texture.uploadBitmapData(_bufBmd); }
		...
		/** Some texture (e.g. spine) should ignore frame information when call adjustVertexData.*/
