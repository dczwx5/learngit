...
package QFLib.Graphics.RenderCore.starling.display
{
    ...
    [Event(name="resize", type="QFLib.Graphics.RenderCore.starling.events.ResizeEvent")]
     ...
     *
     *  @see QFLib.Graphics.RenderCore.starling.events.KeyboardEvent
     *  @see QFLib.Graphics.RenderCore.starling.events.ResizeEvent
     * 
     * */
    public class Stage extends DisplayObjectContainer
    {
                                         ...
                                         transparent:Boolean=true):BitmapData
        {
            ...
            Starling.current.drawToBitmapData(destination);
            Starling.current.present(); // required on some platforms to avoid flickering
