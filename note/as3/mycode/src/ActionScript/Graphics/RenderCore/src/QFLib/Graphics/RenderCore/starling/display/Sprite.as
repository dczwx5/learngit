...
package QFLib.Graphics.RenderCore.starling.display
{
    ...
    //[Event(name="flatten", type="QFLib.Graphics.RenderCore.starling.events.Event")]
        ...
        public override function render(support:RenderSupport, parentAlpha:Number):void
        {
            ...
            if (mFlattenedContents || mFlattenRequested)
            {
                ...
                for (var i:int=0; i<numBatches; ++i)
                {
					...
					quadBatch._material.selfAlpha = this.alpha;
					quadBatch._material.parentAlpha = parentAlpha;
					quadBatch.renderQueue();
                }
            }
