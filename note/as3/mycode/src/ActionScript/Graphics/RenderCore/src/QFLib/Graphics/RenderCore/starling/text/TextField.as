...
package QFLib.Graphics.RenderCore.starling.text
{
    ...
    public class TextField extends DisplayObjectContainer
    {
        ...
        private static const BITMAP_FONT_DATA_NAME:String = "QFLib.Graphics.RenderCore.starling.display.TextField.BitmapFonts";
        ...
        private function createRenderedContents():void
        {
            ...
            texture.root.onRestore = function():void
            {
                if (mTextBounds == null)
                    mTextBounds = new Rectangle();
                var bmd:BitmapData = renderText(scale, mTextBounds);
        ...
        private function updateBorder():void
        {
            ...
            topLine.verticesColor = rightLine.verticesColor = bottomLine.verticesColor = leftLine.verticesColor = mColor;
        }
		 ...
		 * @see QFLib.Graphics.RenderCore.starling.text.TextFieldAutoSize
		 * */
