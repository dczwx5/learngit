...
package QFLib.Graphics.RenderCore.render.pass
{
    ...
    import QFLib.Graphics.RenderCore.render.shader.FAdvColorModify;
    ...
    public class PAdvColorModify extends PassBase implements IPass
    {
        ...
        public function PAdvColorModify ( ...args )
        {
            super ();
            _passName = sName;
        ...
        {
            return this.pma ? Context3DBlendFactor.ONE : Context3DBlendFactor.SOURCE_ALPHA;
        }
