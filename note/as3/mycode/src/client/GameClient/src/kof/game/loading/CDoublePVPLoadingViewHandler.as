...
/**
 * Created by sprite on 2018/5/10.
 */
...
import kof.ui.Loading.CultivateLoadingHeroUI;
import kof.ui.Loading.CultivateLoadingViewUI;

/**
 * 2V2竞技loading界面
 */
public class CDoublePVPLoadingViewHandler extends CViewHandler {

    private var m_pUI : CultivateLoadingViewUI;
    ...
    public function CDoublePVPLoadingViewHandler( bLoadViewByDefault : Boolean = false )
    {
    ...
    override protected function onInitializeView() : Boolean
    {
        ...
        m_pUI = m_pUI || new CultivateLoadingViewUI();
...
//            m_pUI.view_self.txt_infoValue1.text = m_pData.selfHeadInfo.infoValue1 as String;
            ...
            for (var i:int = 0; i < m_pData.selfHeroIdList.length; i++) {
                var heroInfo1:CultivateLoadingHeroUI = m_pUI["view_self_hero" + i];
...
//                heroInfo1.img_hero.mask = heroInfo1.img_mask;
            ...
            m_pUI.view_self.item_head.quality_clip.index = heroData2.qualityLevelValue;
...
//            m_pUI.view_enemy.txt_infoValue1.text = m_pData.enemyHeadInfo.infoValue1 as String;
            ...
            for (i = 0; i < m_pData.enemyHeroIdList.length; i++) {
                var heroInfo2:CultivateLoadingHeroUI = m_pUI["view_enemy_hero" + i];
