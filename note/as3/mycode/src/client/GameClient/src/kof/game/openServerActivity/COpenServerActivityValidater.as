...
public class COpenServerActivityValidater implements ISwitchingValidation{
    private var m_pSystemRef : CAppSystem;
    private var m_bValid : Boolean;

    /** Creates a new CSwitchingMinLevelValidator. */
    public function COpenServerActivityValidater( pSystemRef : CAppSystem ) {
        super();
    ...
    public function evaluate( ... args ) : Boolean {
        ...
        {
            var limitActivityId : int = SYSTEM_ID(KOFSysTags.CARNIVAL_ACTIVITY );
