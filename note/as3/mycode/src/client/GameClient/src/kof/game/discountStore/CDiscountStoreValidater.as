...
public class CDiscountStoreValidater implements ISwitchingValidation {
    private var m_pSystem : CAppSystem;
    private var m_bValid : Boolean = true;

    public function CDiscountStoreValidater(pSystemRef : CAppSystem)
    {
        super();
    ...
    public function evaluate( ... args ) : Boolean
    {
        ...
        {
            var sysID : int = SYSTEM_ID(KOFSysTags.DISCOUNT_STORE );
