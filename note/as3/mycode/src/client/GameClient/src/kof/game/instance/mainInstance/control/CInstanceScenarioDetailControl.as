...
public class CInstanceScenarioDetailControl extends CInstanceControler {
    public function CInstanceScenarioDetailControl() {
    }
    ...
    private function _onUIEvent(e:CViewEvent) : void {
        ...
        switch (subType) {
            ...
            case EInstanceViewEventType.INSTANCE_SWEEP:
                ...
                instanceData = e.data[1] as CChapterInstanceData;
                fightCount = e.data[2] as int;
                if (subType == EInstanceViewEventType.INSTANCE_SWEEP_10) {
                    if (false == playerSystem.playerData.vipHelper.isScenarioInstanceCanSweep10) {
                        var vipLevelCanSweep10:int = playerSystem.playerData.vipHelper.vipLevelSweep10ScenarioInstance;
                        uiCanvas.showMsgAlert(CLang.Get("instance_sweep_10_need_vip", {v1:vipLevelCanSweep10}));
                        break;
                    }
                }
