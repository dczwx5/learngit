...
public class CTextRender extends TextField
{
    ...
    public function CTextRender()
    {
        super();
        var format:TextFormat = new TextFormat("Simsun", 14, 0x000000, false, false, false);
    ...
    {
        super.type = value;
        this.addEventListener(Event.SCROLL, onScroll, false, 0, true);
        if (type == TextFieldType.INPUT)
        {
            this.addEventListener(Event.CHANGE, onTextChange, false, 0, true);
            /*this.addEventListener(FocusEvent.FOCUS_IN,onFocueInHandler);*/
            this.addEventListener(TextEvent.TEXT_INPUT, onTextInput, false, 0, true);
        }
    }
    ...
    private function onFocueInHandler(e:FocusEvent):void
    {
    ...
    public function recoverDefaultFormat():void
    {
