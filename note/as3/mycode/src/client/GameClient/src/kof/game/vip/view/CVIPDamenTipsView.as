...
import kof.ui.master.Vip.VipDaMenTipsUI;

import morn.core.components.SpriteBlitFrameClip;

public class CVIPDamenTipsView extends CViewHandler {

    private var m_TipsUI:VipDaMenTipsUI;
    private var m_bViewInitialized : Boolean;

    private var m_pFrameClip : SpriteBlitFrameClip;

    public function CVIPDamenTipsView() {
        super( false );
    }
    ...
    private function _showHero( e : Event ):void {
        ...
        var vipData: VipLevel = vipManager.getVipLevelTableByID( CVIPSystem.VIP_LEVEL_10 );
