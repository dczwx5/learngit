...
public class CDiscountStoreHelpHandler extends CAbstractHandler {
    public function CDiscountStoreHelpHandler() {
        super();
    }
    ...
    public function getActivityInfo():CActivityHallActivityInfo
    {
        ...
        {
            if(info.table.type == CActivityHallActivityType.DISCOUNT)
            {
                return info;
            }
        }
