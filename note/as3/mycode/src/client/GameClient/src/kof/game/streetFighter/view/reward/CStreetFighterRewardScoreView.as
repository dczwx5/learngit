...
public class CStreetFighterRewardScoreView extends CChildView {
    public function CStreetFighterRewardScoreView() {
    }
    ...
    public virtual override function updateWindow() : Boolean {
        ...
        var datalist:Array = _streetData.rewardData.getRewardRecordListByType([CStreetFighterRewardData.TYPE_SCORE]);
    ...
    private function _onRenderItem(comp:Component, idx:int) : void {
        ...
        item.target_txt.text = CLang.Get("street_fighter_reward_score_target", {v1:target}) + CLang.Get(curKey, {v1:curValue, v2:target});
