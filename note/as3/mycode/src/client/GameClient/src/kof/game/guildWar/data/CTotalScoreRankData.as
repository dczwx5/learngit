 ...
 * 公会战总能源排行单条数据
 */
public class CTotalScoreRankData extends CObjectData {

    public static const Ranking:String = "ranking";
    public static const HeadIcon:String = "headIcon";
    public static const RoleID:String = "roleID";
    public static const Name:String = "name";
    public static const Score:String = "score";

    public function CTotalScoreRankData()
    {
        super();
    }

    public function get ranking() : int { return _data[Ranking]; }
    public function get headIcon() : int { return _data[HeadIcon]; }
