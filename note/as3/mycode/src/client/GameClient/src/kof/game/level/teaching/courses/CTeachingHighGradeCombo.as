...
//高级连击
public class CTeachingHighGradeCombo extends CTeachingCourseBasics {

    protected var pHitArr:Array = [false,false,false,false,false,false,false,false,false];

    protected var targetsIDArr : Array;

    public function CTeachingHighGradeCombo( pTeachingData : TeachingGoal, _system : CAppSystem ) {
...
//            trace("连击失败!!!");
//        }
        pHitArr = [false,false,false,false,false,false,false,false,false];
    }
