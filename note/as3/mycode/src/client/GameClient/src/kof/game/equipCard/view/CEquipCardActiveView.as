...
public class CEquipCardActiveView extends CEquipCardBaseView {
    public function CEquipCardActiveView( system : CAppSystem )
    {
        super( system );
    }
    ...
    {
        _viewUI.img_bg.skin = "png.playerCard.img_cardBg3";
        _viewUI.img_wine.skin = "png.playerCard.img_wine3";
        (_viewUI.getChildByName("btn_tip") as Button).skin = "png.playerCard.btn_knhd_ck03";
