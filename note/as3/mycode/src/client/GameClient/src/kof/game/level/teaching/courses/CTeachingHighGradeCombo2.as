...
public class CTeachingHighGradeCombo2 extends CTeachingCourseBasics {

    protected var pHitArr:Array = [false,false,false,false,false,false,false,false,false,false,false,false,false];

    protected var targetsIDArr : Array;

    public function CTeachingHighGradeCombo2( pTeachingData : TeachingGoal, _system : CAppSystem ) {
...
//        }
        ...
        bool = true;
        pHitArr = [false,false,false,false,false,false,false,false,false,false,false,false,false];
    }

    protected function _onHitTarget( e : CFightTriggleEvent ) : void{
        var paramsList : Array = e.parmList;
        var skillID : int = paramsList[0];
        var rootSkill : int = skillID;//CSkillUtil.getMainSkill( skillID );
