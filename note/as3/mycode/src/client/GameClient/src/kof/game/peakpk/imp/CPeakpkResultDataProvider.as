...
public class CPeakpkResultDataProvider extends CAbstractHandler{
    public function CPeakpkResultDataProvider() {
    }
    ...
    public function getResultData() : CPVPResultData {
        ...
        var peakResultData:CPeakGameSettlementData = _system.data.resultData;
        ...
        obj[CPVPResultData.InstanceType] = EInstanceType.TYPE_PEAK_PK;
        ...
        var embatleListData:CEmbattleListData = pPlayerData.embattleManager.getByType(EInstanceType.TYPE_PEAK_GAME_FAIR);
        ...
        // 敌方数据
        var pEnmeyHeroListData:CPlayerHeroListData = _system.data.matchData.heroList;
        ...
        var selfLevelScoreRecord:PeakScoreLevel = _system.data.getLevelRecordByID(peakResultData.scoreLevelID);
        ...
        var enemyLevelScoreRecord:PeakScoreLevel = _system.data.getLevelRecordByID(peakResultData.enemyScoreLevelID);
        ...
        obj[CPVPResultData.SelfValue] = peakSystem.manager.data.score;
