...
public class CIMRecommendData extends CObjectData {
    public function CIMRecommendData() {
        super();
        _data = new CMap();
    }
    ...
    public function get isHaveAgree() : int { return _data[_isHaveAgree]; }
    ...
    public static function createObjectData(name:String, battleValue:Number,level:int,headID:int,roleID:Number,isHaveAgree:int,isOnline:int,isGet:int,
        ...
        return {name:name, battleValue:battleValue,level:level,headID:headID,roleID:roleID,isHaveAgree:isHaveAgree,isOnline:isOnline,isGet:isGet,
    ...
    public static const _isHaveAgree:String = "isHaveAgree";
