...
package morn.editor.pluginui.test {
	import morn.core.components.*;import morn.editor.*;
	public class TestPageUI extends PluginDialog {
		protected static var uiXML:XML =
			<PluginDialog width="600" height="400">
			  ...
			  <List x="344" y="318" repeatY="5" repeatX="1" width="73" height="110">
			    <Box name="render">
			      <KOFLabel text="kof_label"/>
			    </Box>
			  </List>
			</PluginDialog>;
