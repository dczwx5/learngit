 ...
 */
public class CSwitchingAddCommand extends CAbstractConsoleCommand {

    public function CSwitchingAddCommand() {
        super( "st_add", "Add a system bundle by switching." );
        ...
        if ( super.onCommand( args ) ) {
            ...
            if ( pSystemBundleCtx ) {
                ...
                if ( !pSystemBundle ) {
                    ...
                    pSystemBundleCtx.setUserData( pSystemBundle, "visible", true );
                }
                return true;
            } else {
