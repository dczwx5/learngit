...
public class CEntityNormalMonCriteria extends CAbstractCriteria {
    public function CEntityNormalMonCriteria() {
        super();
    }
    ...
    override public function meetCriteria( target : CGameObject ) : Boolean
    {
        ...
        if( objType == CCharacterDataDescriptor.TYPE_MONSTER )
        {
            ...
            if( pMonProperty && pMonProperty.monsterType == EMonsterType.NORMAL )
                    return true;
            return false;
        }else{
            return false;
