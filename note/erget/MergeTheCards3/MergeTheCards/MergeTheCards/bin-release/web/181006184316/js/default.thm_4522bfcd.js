window.skins={};
	...
	_proto.lb_context_i = function () {
		...
		t.scaleY = 1;
		t.size = 36;
		t.text = "1、合并相同价值的卡牌，收集积分。  \n\n2、当前的手牌不理想？不用担心，你可以将它拖动到右下角的丢弃区进行丢弃。  \n\n3、所有的手牌都很糟糕！怎么办？快点击左下角的刷新按钮，重新获取一副理想的手牌。  \n\n4、当你合并出一张价值2048的卡牌时，会有意想不到的效果，它将为你收集大量的积分。  \n\n那么，祝你好运！";
		t.textColor = 0x000000;
		t.top = 5;
		t.y = 0;
		return t;
	...
	var MainViewSkin$Skin1 = 	(function (_super) {
		...
		function MainViewSkin$Skin1() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","01_btn_start")
					])
				,
				new eui.State ("disabled",
					[
	...
	var MainViewSkin$Skin2 = 	(function (_super) {
		__extends(MainViewSkin$Skin2, _super);
		function MainViewSkin$Skin2() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","01_btn_freeSkin")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = MainViewSkin$Skin2.prototype;

		_proto._Image1_i = function () {
			var t = new eui.Image();
			this._Image1 = t;
			t.percentHeight = 100;
			t.source = "01_btn_freeSkin";
			t.percentWidth = 100;
			return t;
		};
		_proto.labelDisplay_i = function () {
		...
		return MainViewSkin$Skin2;
	})(eui.Skin);

	var MainViewSkin$Skin3 = 	(function (_super) {
		__extends(MainViewSkin$Skin3, _super);
		function MainViewSkin$Skin3() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","01_btn_rank")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = MainViewSkin$Skin3.prototype;

		_proto._Image1_i = function () {
			var t = new eui.Image();
			this._Image1 = t;
			t.percentHeight = 100;
			t.source = "01_btn_rank";
			t.percentWidth = 100;
			return t;
		};
		_proto.labelDisplay_i = function () {
		...
		return MainViewSkin$Skin3;
	})(eui.Skin);

	var MainViewSkin$Skin4 = 	(function (_super) {
		__extends(MainViewSkin$Skin4, _super);
		function MainViewSkin$Skin4() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","01_btn_share")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = MainViewSkin$Skin4.prototype;

		_proto._Image1_i = function () {
			var t = new eui.Image();
			this._Image1 = t;
			t.percentHeight = 100;
			t.source = "01_btn_share";
			t.percentWidth = 100;
			return t;
		};
		_proto.labelDisplay_i = function () {
		...
		return MainViewSkin$Skin4;
	})(eui.Skin);

	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["img_bg","btn_start","btn_shop","btn_rank","btn_share","wxOtherGameIcon0","wxOtherGameIcon1","grp_content"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this.img_bg_i(),this._Image1_i(),this.grp_content_i()];
	}
	...
	_proto.grp_content_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1080;
		t.elementsContent = [this.btn_start_i(),this._Group4_i(),this.wxOtherGameIcon0_i(),this.wxOtherGameIcon1_i()];
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.x = 1;
		t.y = 60;
		t.elementsContent = [this.btn_shop_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.x = 65;
		t.y = 179;
		t.elementsContent = [this.btn_rank_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.scaleY = 1;
		t.width = 190;
		t.x = 79.99999999999989;
		t.y = 331;
		t.elementsContent = [this.btn_share_i()];
		return t;
	};
