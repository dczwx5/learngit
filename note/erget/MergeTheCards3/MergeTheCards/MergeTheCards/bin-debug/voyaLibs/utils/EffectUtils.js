...
var Utils;
(function (Utils) {
    var ChangeSceneEffect = (function () {
        function ChangeSceneEffect() {
        }
        /**
         * 切换场景的特效
         * @param style
         ...
         *  5.随机一种
         */
        ChangeSceneEffect.play = function (style) {
            //创建一个截图Bitmap
    ...
    Utils.ChangeSceneEffect = ChangeSceneEffect;
    __reflect(ChangeSceneEffect.prototype, "Utils.ChangeSceneEffect");
})(Utils || (Utils = {}));
