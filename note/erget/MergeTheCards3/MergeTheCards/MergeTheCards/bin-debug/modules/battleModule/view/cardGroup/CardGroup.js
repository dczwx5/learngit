...
var CardGroup = (function (_super) {
    ...
    CardGroup.prototype.mergeCard = function (distCardCfg, addScore) {
        return __awaiter(this, void 0, void 0, function () {
            var lastCard, lastButOneCard, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        result = false;
                        if (!(lastCard.cfg.type == Enum_CardType.BOMB || distCardCfg.type == Enum_CardType.BOMB)) return [3 /*break*/, 2];
                        this.flyScoreTip(lastCard, distCardCfg, addScore);
                        return [4 /*yield*/, this.removeAllCardsAsync()];
                    case 1:
                        _a.sent();
                        result = true;
                        return [3 /*break*/, 5];
                    ...
                    case 3:
                        ...
                        this._cardList.pop();
                        lastCard.restore();
                        return [4 /*yield*/, this.playMergeEff(lastButOneCard, distCardCfg)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    CardGroup.prototype.playMergeEff = function (lastButOneCard, distCardCfg) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    CardGroup.prototype.removeAllCardsAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var lastButOneCard, frontValue, frontCardType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // this.touchChildren = false;
                        this.touchEnabled = false;
                        frontValue = this.lastCard.cfg.value;
                        frontCardType = this.lastCard.cfg.type;
                        _a.label = 1;
                    case 1:
