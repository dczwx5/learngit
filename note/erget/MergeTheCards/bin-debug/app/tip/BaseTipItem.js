...
(function (App) {
    var BaseTipItem = (function (_super) {
        ...
        Object.defineProperty(BaseTipItem.prototype, "cachePool", {
            get: function () {
        ...
        BaseTipItem._cachePool = new VL.ObjectCache.ObjectPool(BaseTipItem);
        return BaseTipItem;
    }(eui.Component));
    App.BaseTipItem = BaseTipItem;
    __reflect(BaseTipItem.prototype, "App.BaseTipItem", ["App.ITipItem", "VL.ObjectCache.ICacheable"]);
})(App || (App = {}));
