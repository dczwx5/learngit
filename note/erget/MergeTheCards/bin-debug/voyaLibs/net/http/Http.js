...
(function (VL) {
    ...
    (function (Net) {
        var Http = (function () {
            function Http() {
                this.reqHeader = null;
                this.dg_HttpError = new VL.Delegate();
            }
            /**
             *
             * @param key
            ...
            //     }).send();
            // }
            Http.prototype.send = function (httpReqPack, onResp, thisObj) {
                return __awaiter(this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, create(Net.HttpTransaction).init(httpReqPack, function (respPack, otherData) {
                                    _this.onResult(respPack, onResp.bind(thisObj), httpReqPack);
                                }).send()];
            ...
            Http.prototype.onResult = function (respPack, respHandler, reqPack) {
            ...
            Http.prototype.onSuccess = function (respPack, respHandler, reqPack) {
                respHandler(respPack.data, reqPack.otherData);
                reqPack.restore();
            };
            Http.prototype.onFail = function (respPack, respHandler, reqPack) {
                this.dg_HttpError.boardcast({ key: reqPack.key, data: respPack.data, otherData: reqPack.otherData });
            };
            return Http;
        }());
        Net.Http = Http;
        __reflect(Http.prototype, "VL.Net.Http");
    })(Net = VL.Net || (VL.Net = {}));
})(VL || (VL = {}));
