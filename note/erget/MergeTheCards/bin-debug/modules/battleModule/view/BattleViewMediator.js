...
var BattleViewMediator = (function (_super) {
    ...
    BattleViewMediator.prototype.onViewOpen = function () {
        ...
        var group;
        var skinMng = this.getModel(SkinModel).skinMng;
    ...
    BattleViewMediator.prototype.onCarrCardAppendedToGroup = function (msg) {
        // let card = msg.body.card;
        var group = this.view.getCardGroup(msg.body.groupIdx);
        var card = create(Card).init(msg.body.card, this.getModel(SkinModel).skinMng);
        group.appendCard(card);
    };
