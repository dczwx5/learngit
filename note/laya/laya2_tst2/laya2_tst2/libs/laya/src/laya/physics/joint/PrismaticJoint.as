	...
	public class PrismaticJoint extends Component {
		...
		private function _createJoint():void {
			if (!joint) {
				...
				var def:* = new box2d.b2PrismaticJointDef();
		...
		public function set enableMotor(value:Boolean):void {
			_enableMotor = value;
			if (joint) joint.EnableMotor(value);
		}
		...
		public function set motorSpeed(value:Number):void {
			_motorSpeed = value;
			if (joint) joint.SetMotorSpeed(value);
		}
		...
		public function set maxMotorForce(value:Number):void {
			...
			if (joint) joint.SetMaxMotorForce(value);
		}
		...
		public function set enableLimit(value:Boolean):void {
			_enableLimit = value;
			if (joint) joint.EnableLimit(value);
		}
		...
		public function set lowerTranslation(value:Number):void {
			...
			if (joint) joint.SetLimits(value, _upperTranslation);
		}
		...
		public function set upperTranslation(value:Number):void {
			...
			if (joint) joint.SetLimits(_lowerTranslation, value);
		}
	}
}