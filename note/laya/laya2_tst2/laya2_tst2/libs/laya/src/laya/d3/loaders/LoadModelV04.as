package laya.d3.loaders {
	...
	import laya.d3.graphics.Vertex.VertexPositionNTBTexture;
	import laya.d3.graphics.Vertex.VertexPositionNTBTexture0Texture1Skin;
	import laya.d3.graphics.Vertex.VertexPositionNormal;
	import laya.d3.graphics.Vertex.VertexPositionNormalColor;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorSkin;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorSkinSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTexture;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTexture0Texture1;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTexture0Texture1STangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTexture0Texture1Skin;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTexture0Texture1SkinSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTextureSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTextureSkin;
	import laya.d3.graphics.Vertex.VertexPositionNormalColorTextureSkinSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalTexture;
	import laya.d3.graphics.Vertex.VertexPositionNormalTexture0Texture1;
	import laya.d3.graphics.Vertex.VertexPositionNormalTexture0Texture1STangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalTexture0Texture1Skin;
	import laya.d3.graphics.Vertex.VertexPositionNormalTexture0Texture1SkinSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalTextureSTangent;
	import laya.d3.graphics.Vertex.VertexPositionNormalTextureSkin;
	import laya.d3.graphics.Vertex.VertexPositionNormalTextureSkinSTangent;
	...
	public class LoadModelV04 {
		...
		private static function READ_SUBMESH():Boolean {
			...
			bufferState.bindBufferState();
			bufferState.applyVertexBuffer(vertexBuffer);
			bufferState.applyIndexBuffer(indexBuffer);
			bufferState.unBindBufferState();
			submesh._applyBufferState(bufferState);
