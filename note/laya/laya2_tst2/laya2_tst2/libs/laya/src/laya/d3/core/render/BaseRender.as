package laya.d3.core.render {
	...
	public class BaseRender extends EventDispatcher implements ISingletonElement {
		...
		/** @private  */
		private var _indexInShadowCastList:int = -1;
		...
		/** @private */
		public var _indexInCastShadowList:int;
		/** @private */
		 ...
		 */
		public function BaseRender(owner:RenderableSprite3D, shaderDataSize:int) {
			...
			_shaderValues = new ShaderData(null, shaderDataSize);
