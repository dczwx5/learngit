package laya.layagl.cmdNative {
	...
	public class DrawPathCmdNative  {
		...
		public static function create(x:Number,y:Number,paths:Array,brush:Object,pen:Object):DrawPathCmdNative {
			...
			{
				_DRAW_LINES_CMD_ENCODER_ = LayaGL.instance.createCommandEncoder(88, 32, true);
			...
			{
				_DRAW_FILL_CMD_ENCODER_ = LayaGL.instance.createCommandEncoder(88, 32, true);
			...
			{
				_DRAW_LINES_FILL_CMD_ENCODER_ = LayaGL.instance.createCommandEncoder(136, 32, true);
