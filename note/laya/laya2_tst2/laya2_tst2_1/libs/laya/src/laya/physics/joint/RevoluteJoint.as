	...
	public class RevoluteJoint extends Component {
		...
		private function _createJoint():void {
			if (!joint) {
				...
				var def:* = new box2d.b2RevoluteJointDef();
		...
		public function set maxMotorTorque(value:Number):void {
			...
			if (joint) joint.SetMaxMotorTorque(value);
		}
		...
		public function set lowerAngle(value:Number):void {
			_lowerAngle = value;
			if (joint) joint.SetLimits(value, _upperAngle);
		}
		...
		public function set upperAngle(value:Number):void {
			_upperAngle = value;
			if (joint) joint.SetLimits(_lowerAngle, value);
		}
	}
}