package laya.layagl {
	...
	public class LayaNative2D {
		...
		public static function _init_simple_texture_cmdEncoder_():void {
			_SIMPLE_TEXTURE_CMDENCODER_ = LayaGL.instance.createCommandEncoder(124, 32, true);
		...
		public static function _init_simple_rect_cmdEncoder_():void {
			_SIMPLE_RECT_CMDENCODER_ = LayaGL.instance.createCommandEncoder(84, 32, true);
		...
		public static function _init_rect_border_cmdEncoder_():void {
			_RECT_BORDER_CMD_ENCODER_ = LayaGL.instance.createCommandEncoder(84, 32, true);
