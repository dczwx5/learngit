package a_core.character.state
{
	 ...
	 * @author
	 */
	public class CCharacterMoveState extends CCharacterState {
		public function CCharacterMoveState(){
		...
		private function _onReady(animation:CCharacterAnimation) : void {
			animation.playAnimation(EAnimation.MOVE);
			m_isReady = true;
		}
		...
		protected override function onUpdate(fsm:CFsm, deltaTime:Number) : void {
			...
			if (!movement.needToMove) {
				changeState(fsm, CCharacterIdleState);
			}
		}
