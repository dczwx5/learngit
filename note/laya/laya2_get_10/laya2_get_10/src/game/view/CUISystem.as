package game.view
{
	...
	public class CUISystem extends CAppSystem implements IUICanvas {
		...
		public function showMsg(msg:String) : void {
			(getBean(CMessageView) as CMessageView).data = msg;
			(getBean(CMessageView) as CMessageView).show();
		}

		public function addToTopLayer(comp:Sprite, isCenter:Boolean = true) : void {
			_topLayer.addChild(comp);
			if (isCenter) {
				comp.x = (CCommon.screenWidth - comp.displayWidth) * 0.5;
				comp.y = (CCommon.screenHeight - comp.displayHeight) * 0.5;
			}
		}
		...
		public function removeTopView(view:Sprite) : void {
			_topLayer.removeChild(view);
		}
