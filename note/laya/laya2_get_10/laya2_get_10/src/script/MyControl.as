package script {
    ...
    public class MyControl extends Script {
        ...
        override public function onEnable():void {
            ...
            m_curScoreLbl = owner.getChildByName("curScore") as Label;
        ...
        private function _onStageStarted() : void {
            ...
            pSceneSystem.sceneContainer = (owner).getChildByName("sceneLayer") as Sprite;

            var uiSystem:CUISystem = gameStage.getSystem(CUISystem) as CUISystem;
            uiSystem.container = (owner).getChildByName("uiLayer") as Sprite;
        ...
        private function _onPlayerDataHandler() : void {
            var scoreTxt:Label = m_curScoreLbl;
        ...
        private var m_curScoreLbl:Label;
