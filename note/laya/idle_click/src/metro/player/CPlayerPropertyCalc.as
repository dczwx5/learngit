package metro.player
{
	...
	public class CPlayerPropertyCalc{
		...
		public static function calcDpsByBuilding(buildingData:CBuildingItemData) : Number {
			var ret:Number = buildingData.lv  * buildingData.lv * calcDpsAddByBuilding(buildingData);
			return ret;
		}
		public static function calcDpsAddByBuilding(buildingData:CBuildingItemData) : Number {
			var ret:Number = buildingData.ID * buildingData.ID * 100;
			return ret;
		}
		public static function calcBuildlingLvupCost(buildingData:CBuildingItemData) : Number {
			var ret:Number = (buildingData.lv*buildingData.lv + buildingData.ID * 10);
			return ret;
		}
